...
public class Grade {
	...
	public Grade(double total, JSONObject choice, JSONObject fill, JSONObject judge, JSONObject q_short,
			JSONObject q_compute) {
		super();
		this.total = total;
		this.choice = choice;
	...
	public String toString() {
		return "Grade [total=" + total + ", choice=" + choice + ", fill=" + fill + ", judge=" + judge + ", q_short="
				+ q_short + ", q_compute=" + q_compute + "]";
	}
}
